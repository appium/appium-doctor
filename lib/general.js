...
class OptionalOpencv4nodejsCommandCheck extends DoctorCheck {
  ...
  async fix () { // eslint-disable-line require-await
    return 'Why opencv4nodejs is needed and how to install it is: https://github.com/appium/appium/blob/master/docs/en/writing-running-appium/image-comparison.md';
  }
}
...
class OptionalFfmpegCommandCheck extends DoctorCheck {
  async diagnose () {
    ...
    return ffmpegPath
      ? okOptional(`ffmpeg is installed at: ${ffmpegPath}`)
