...
class OptionalFbsimctlCommandCheck extends DoctorCheck {
  ...
  async fix () { // eslint-disable-line require-await
    return `Why fbsimctl needs and how to install it is: http://appium.io/docs/en/drivers/ios-xcuitest/`;
  }
}
...
export {
  ...
  AuthorizationDbCheck, CarthageCheck, OptionalFbsimctlCommandCheck, OptionalApplesimutilsCommandCheck
};
