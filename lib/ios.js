...
class OptionalFbsimctlCommandCheck extends DoctorCheck {
  ...
  async fix () { // eslint-disable-line require-await
    return 'Why fbsimctl is needed and how to install it is: http://appium.io/docs/en/drivers/ios-xcuitest/';
  }
}
...
class OptionalApplesimutilsCommandCheck extends DoctorCheck {
  ...
  async fix () { // eslint-disable-line require-await
    return 'Why applesimutils is needed and how to install it is: http://appium.io/docs/en/drivers/ios-xcuitest/';
  }
}
